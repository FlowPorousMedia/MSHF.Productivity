...
class CharacteristicData:
    ...
    def __eq__(self, other) -> bool:
        ...
        return (
            math.isclose(self.perm, other.perm, rel_tol=1e-9, abs_tol=1e-12) and
            math.isclose(self.mu, other.mu, rel_tol=1e-9, abs_tol=1e-12) and
            math.isclose(self.x0, other.x0, rel_tol=1e-9, abs_tol=1e-12) and
            math.isclose(self.pw, other.pw, rel_tol=1e-9, abs_tol=1e-12) and
            math.isclose(self.pr, other.pr, rel_tol=1e-9, abs_tol=1e-12)
        )
